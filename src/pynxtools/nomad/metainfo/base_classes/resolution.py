...
#
# This file is generated from the NeXus definition NXresolution (see
...
# Run `pynx nomad generate-metainfo --nxdl NXresolution` to regenerate.
...
class Resolution(Object, ArchiveSection):
    """
