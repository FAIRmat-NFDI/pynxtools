...
#
# This file is generated from the NeXus definition NXelement (see
...
# Run `pynx nomad generate-metainfo --nxdl NXelement` to regenerate.
...
class Element(Object):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXelement.html#nxelement"
        ],
    ...
    symbol = Quantity(
        ...
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXelement.html#nxelement-symbol-field"
        ],
        description=(
