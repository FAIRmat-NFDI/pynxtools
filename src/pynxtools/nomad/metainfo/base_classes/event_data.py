...
#
# This file is generated from the NeXus definition NXevent_data (see
...
# Run `pynx nomad generate-metainfo --nxdl NXevent_data` to regenerate.
...
class EventData(Object, ArchiveSection):
    """
