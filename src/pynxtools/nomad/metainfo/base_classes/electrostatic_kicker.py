...
#
# This file is generated from the NeXus definition NXelectrostatic_kicker (see
...
class ElectrostaticKicker(Component):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXelectrostatic_kicker.html#nxelectrostatic_kicker"
        ],
        a_nexus_definition=NeXusDefinition(
            nx_class="NXelectrostatic_kicker",
            category="base",
        ),
    )
...
class ElectrostaticKickerReadCurrent(Log):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXelectrostatic_kicker.html#nxelectrostatic_kicker-read-current-group"
        ],
...
class ElectrostaticKickerReadVoltage(Log):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXelectrostatic_kicker.html#nxelectrostatic_kicker-read-voltage-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXlog",
            name="read_voltage",
