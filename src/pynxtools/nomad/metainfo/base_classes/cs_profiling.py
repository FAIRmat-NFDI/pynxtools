...
#
# This file is generated from the NeXus definition NXcs_profiling (see
...
# Run `pynx nomad generate-metainfo --nxdl NXcs_profiling` to regenerate.
...
class CsProfiling(Object, ArchiveSection):
    """
