...
#
# This file is generated from the NeXus definition NXseparator (see
...
class Separator(Component):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator"
        ],
        a_nexus_definition=NeXusDefinition(
            nx_class="NXseparator",
            category="base",
        ),
    )
    ...
    beamline_distance = Quantity(
        type=np.float64,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-beamline-distance-field"
        ],
    ...
    set_Bfield_current = Quantity(
        type=np.float64,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-set-bfield-current-field"
        ],
    ...
    set_Efield_voltage = Quantity(
        type=np.float64,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-set-efield-voltage-field"
        ],
...
class SeparatorReadBfieldCurrent(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-read-bfield-current-group"
        ],
...
class SeparatorReadBfieldVoltage(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-read-bfield-voltage-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXlog",
...
class SeparatorReadEfieldCurrent(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-read-efield-current-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXlog",
...
class SeparatorReadEfieldVoltage(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXseparator.html#nxseparator-read-efield-voltage-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXlog",
