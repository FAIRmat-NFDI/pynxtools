...
#
# This file is generated from the NeXus definition NXtransformations (see
...
# Run `pynx nomad generate-metainfo --nxdl NXtransformations` to regenerate.
...
class Transformations(Object, ArchiveSection):
    """
