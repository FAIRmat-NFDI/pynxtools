...
#
# This file is generated from the NeXus definition NXcg_face_list_data_structure (see
...
# Run `pynx nomad generate-metainfo --nxdl NXcg_face_list_data_structure` to regenerate.
