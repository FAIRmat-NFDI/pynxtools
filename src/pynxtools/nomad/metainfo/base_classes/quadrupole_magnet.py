...
#
# This file is generated from the NeXus definition NXquadrupole_magnet (see
...
# Run `pynx nomad generate-metainfo --nxdl NXquadrupole_magnet` to regenerate.
...
__all__ = ["QuadrupoleMagnet"]


class QuadrupoleMagnet(Component):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXquadrupole_magnet.html#nxquadrupole_magnet"
        ],
        a_nexus_definition=NeXusDefinition(
            nx_class="NXquadrupole_magnet",
            category="base",
        ),
    )
...
class QuadrupoleMagnetReadCurrent(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXquadrupole_magnet.html#nxquadrupole_magnet-read-current-group"
        ],
...
class QuadrupoleMagnetReadVoltage(Log):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXquadrupole_magnet.html#nxquadrupole_magnet-read-voltage-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXlog",
            name="read_voltage",
