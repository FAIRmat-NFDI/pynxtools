...
#
# This file is generated from the NeXus definition NXlauetof (see
...
class Lauetof(Entry, basesections.Measurement):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof"
        ],
    ...
    instrument = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.lauetof.LauetofInstrument",
        repeats=False,
    )
    sample = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.lauetof.LauetofSample",
        repeats=False,
    )
    control = SubSection(
...
class LauetofInstrument(Instrument):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-instrument-group"
        ],
    ...
    detector = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.lauetof.LauetofInstrumentDetector",
        repeats=False,
    )
...
class LauetofInstrumentDetector(Detector):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-instrument-detector-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXdetector",
            name="detector",
    ...
    data_quantity__signal = Quantity(
        type=MEnum(["1"]),
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-instrument-detector-data-signal-attribute"
        ],
...
class LauetofSample(Sample):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-sample-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXsample",
            name="sample",
...
class LauetofControl(Monitor):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-control-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXmonitor",
            name="control",
    ...
    mode = Quantity(
        ...
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXlauetof.html#nxlauetof-entry-control-mode-field"
        ],
        description=(
