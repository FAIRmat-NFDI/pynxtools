...
#
# This file is generated from the NeXus definition NXxeuler (see
...
class XeulerInstrument(XbaseInstrument):
    m_def = Section(
        links=[
...
class XeulerInstrumentDetector(XbaseInstrumentDetector):
    m_def = Section(
        links=[
