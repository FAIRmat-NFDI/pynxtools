...
#
# This file is generated from the NeXus definition NXxas_pey (see
...
# Run `pynx nomad generate-metainfo --nxdl NXxas_pey` to regenerate.
...
class XasPey(Xas):
    r"""
    In partial electron yield (PEY), the XAS spectrum is measured by collecting
    electrons above a certain kinetic energy threshold. A retarding voltage
    (bias) is applied to discriminate against low-energy secondary electrons,
    selecting only higher-energy Auger or photoelectrons:
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey"
        ],
    ...
    instrument = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.xas_pey.XasPeyInstrument",
        repeats=True,
        variable=True,
    )
    process = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.xas_pey.XasPeyProcess",
        repeats=True,
        variable=True,
    )

    definition = Quantity(
        type=MEnum(["NXxas_pey"]),
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-definition-field"
        ],
...
class XasPeyInstrument(Instrument):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-instrument-group"
        ],
        variable=True,
    ...
    i0 = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.xas_pey.XasPeyInstrumentI0",
        repeats=False,
    )
    iey = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.xas_pey.XasPeyInstrumentIey",
        repeats=False,
    )
...
class XasPeyInstrumentI0(Detector):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-instrument-i0-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXdetector",
            name="i0",
...
class XasPeyInstrumentIey(Detector):
    """
    Detector measuring the partial electron yield :math:`I_{ey}`.
    """

    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-instrument-iey-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXdetector",
            name="iey",
    ...
    retarding_voltage = Quantity(
        type=np.float64,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-instrument-iey-retarding-voltage-field"
        ],
        dimensionality="[mass] * [length] ** 2 / [time] ** 3 / [current]",
        unit="volt",
        description=(
            "The retarding voltage (bias) applied to select electrons above a "
            "kinetic energy threshold."
        ),
        a_nexus_field=NeXusField(
            name="retarding_voltage",
            type="NX_FLOAT",
            name_type="specified",
            optionality="optional",
            units="NX_VOLTAGE",
...
class XasPeyProcess(Process):
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-process-group"
        ],
        variable=True,
        a_nexus_group=NeXusGroup(
            nx_class="NXprocess",
    ...
    program = Quantity(
        type=str,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-process-program-field"
        ],
    ...
    version = Quantity(
        type=str,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/contributed_definitions/NXxas_pey.html#nxxas_pey-entry-process-version-field"
        ],
