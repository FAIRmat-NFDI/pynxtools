...
#
# This file is generated from the NeXus definition NXtofsingle (see
...
# Run `pynx nomad generate-metainfo --nxdl NXtofsingle` to regenerate.
...
class Tofsingle(Entry, basesections.Measurement):
    """
    ...
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle"
        ],
        categories=[ExperimentCategory],
        a_nexus_definition=NeXusDefinition(
            nx_class="NXtofsingle",
    ...
    user = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.tofsingle.TofsingleUser",
        repeats=False,
    )
    instrument = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.tofsingle.TofsingleInstrument",
        repeats=True,
        variable=True,
    )
    sample = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.tofsingle.TofsingleSample",
        repeats=True,
        variable=True,
    )
    monitor = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.tofsingle.TofsingleMonitor",
        repeats=True,
        variable=True,
    )
    data = SubSection(
        section_def="pynxtools.nomad.metainfo.applications.tofsingle.TofsingleData",
        repeats=False,
    )
    ...
    title = Quantity(
        type=str,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-title-field"
        ],
    ...
    start_time = Quantity(
        type=Datetime,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-start-time-field"
        ],
        a_nexus_field=NeXusField(
            name="start_time",
            type="NX_DATE_TIME",
    ...
    definition = Quantity(
        type=MEnum(["NXtofsingle"]),
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-definition-field"
        ],
    ...
    duration = Quantity(
        type=np.float64,
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-duration-field"
        ],
        a_nexus_field=NeXusField(
            name="duration",
            type="NX_FLOAT",
...
class TofsingleUser(User):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-user-group"
        ],
...
class TofsingleInstrument(Instrument):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-instrument-group"
        ],
        variable=True,
        a_nexus_group=NeXusGroup(
...
class TofsingleInstrumentDetector(Detector):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-instrument-detector-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXdetector",
            name="detector",
...
class TofsingleSample(Sample):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-sample-group"
        ],
        variable=True,
        a_nexus_group=NeXusGroup(
            nx_class="NXsample",
    ...
    nature = Quantity(
        ...
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-sample-nature-field"
        ],
        a_nexus_field=NeXusField(
            name="nature",
            type="NX_CHAR",
...
class TofsingleMonitor(Monitor):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-monitor-group"
        ],
        variable=True,
        a_nexus_group=NeXusGroup(
            nx_class="NXmonitor",
    ...
    mode = Quantity(
        ...
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-monitor-mode-field"
        ],
        description=(
...
class TofsingleData(Data):
    m_def = Section(
        links=[
            "https://fairmat-nfdi.github.io/nexus_definitions/classes/applications/NXtofsingle.html#nxtofsingle-entry-data-group"
        ],
        a_nexus_group=NeXusGroup(
            nx_class="NXdata",
            name="data",
