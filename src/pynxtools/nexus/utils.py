...
#
"""Low-level utility helpers for NeXus/HDF5 data decoding.

This module intentionally has minimal dependencies so it can be imported
safely from any layer of the pynxtools package without risk of circular
imports.
"""
