...
class NxEmUser:  # pylint: disable=R0903
    ...
    def report(self, prefix: str, template: dict) -> dict:
        ...
        template[prefix + "/social_media_name"] = self.meta["social_media_name"].value
        template[prefix + "/social_media_platform"] = self.meta[
            "social_media_platform"
        ].value
        template[prefix + "/telephone_number"] = self.meta["telephone_number"].value
        return template
...
class NxEmAppDefHeader:  # pylint: disable=R0903
    ...
    def report(self, prefix: str, template: dict) -> dict:
        ...
        template[prefix + "/experiment_identifier"] = self.meta[
            "experiment_identifier"
        ].value
        template[prefix + "/experiment_description"] = self.meta[
        ...
        template[prefix + "/program/@version"] = self.meta["program_version"].value
        template[prefix + "/experiment_documentation"] = self.meta[
            "experiment_documentation"
        ].value
        template[prefix + "/thumbnail"] = self.meta["thumbnail"].value
        template[prefix + "/thumbnail/@type"] = self.meta["thumbnail_type"].value
        return template
