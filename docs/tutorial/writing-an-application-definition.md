...
|-------|------|-------|------------|
| Required | *(none)* | `\exists: required` | Fail/warn if absent |
| Recommended | `recommended="true"` | `\exists: recommended` | Warn if absent or accept |
| Optional | `optional="true"` | `\exists: optional` | Silently accept if absent |
