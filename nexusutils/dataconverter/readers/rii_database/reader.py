...
def read_dispersion(filename: str) -> Dict[str, Any]:
    ...
    def tabulated_nk(data: str):
        ...
        entries[f'{bpath}/wavelength/@units'] = 'nm'
        entries[f'{bpath}/energy'] = 1240. / daf.index
        entries[f'{bpath}/energy/@units'] = 'eV'
        entries[f'{bpath}/refractive_index'] = daf['n'] + 1j * daf['k']
        entries[f'{bpath}/dielectric_function'] = (daf['n'] + 1j * daf['k'])**2
    ...
    def polynomial(coeffs: List[float]):
        ...
        entries[f'{bpath}/REPEATED_PARAMS[f]/values/@units'] = '1/nanometer**e'
    ...
    def sellmeier_polynomial(coeffs: List[float]):
        ...
        # entries[f'{bpath_poly}/REPEATED_PARAMS[f]/values'] = coeffs[1::2]
        # entries[f'{bpath_poly}/REPEATED_PARAMS[f]/values/@units'] = '1/nanometer**e'
        # entries[f'{bpath_poly}/REPEATED_PARAMS[e]/name'] = 'e'
        # entries[f'{bpath_poly}/REPEATED_PARAMS[e]/values'] = coeffs[2::2]
    ...
    def cauchy(coeffs: List[float]):
        ...
        entries[f'{bpath}/REPEATED_PARAMS[e]/name'] = 'e'
        entries[f'{bpath}/REPEATED_PARAMS[e]/values'] = coeffs[2::2]
        entries[f'{bpath}/REPEATED_PARAMS[e]/values/@units'] = '1/nanometer**e'
