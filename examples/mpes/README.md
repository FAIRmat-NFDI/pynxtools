...
dataconverter --reader mpes \\
    --nxdl NXmpes \\
    --input-file xarray_saved_small_calibration.h5 \\
...
Yes, [here](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-remote-tools-hub/-/tree/develop/docker/mpes/example) you can find exhaustive examples how to use `pynxtools` for your ARPES research data pipeline.
