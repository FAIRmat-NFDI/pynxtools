...
@pytest.mark.parametrize('path,value', [
    ...
    pytest.param('CONTRIBUTED.NXentry.nx_kind', 'group'),
    pytest.param('CONTRIBUTED.NXentry.defaultAttribute.nx_value.type', str),
    pytest.param('CONTRIBUTED.NXentry.nx_attribute_default', '*'),
    pytest.param('CONTRIBUTED.NXentry.NXdataGroup', '*'),
    pytest.param('BASE_CLASSES.NXdetector.real_timeField', '*'),
    pytest.param('CONTRIBUTED.NXentry.NXdataGroup.nx_optional', True),
    pytest.param('CONTRIBUTED.NXentry.nx_group_DATA.section_def.nx_kind', 'group'),
    pytest.param('CONTRIBUTED.NXentry.nx_group_DATA.section_def.nx_optional', True),
    pytest.param('CONTRIBUTED.NXentry.nx_group_DATA.section_def.nx_name.type', str),
    ...
    pytest.param('CONTRIBUTED.NXentry.nx_category', 'base'),
    pytest.param('APPLICATIONS.NXentry.nx_category', 'base'),
    pytest.param('BASE_CLASSES.NXentry.nx_category', 'base'),
    pytest.param('CONTRIBUTED.NXapm.nx_category', 'application')
])
