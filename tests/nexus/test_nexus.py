...
@pytest.mark.parametrize(
    ...
    [
        # --- Floats ---
        (0.0, 8, "0.0"),
        (-0.0, 8, "-0.0"),  # preserve binary zero sign
        (0.00000001, 8, "0.00000001"),  # not treated as zero
        (-0.00000001, 8, "-0.00000001"),
        (-0.00000001, 8, "-0.00000001"),
        (0.000000001, 8, "1.00000000e-09"),
        (1e-9, 8, "1.00000000e-09"),
        (1e-15, 8, "1.00000000e-15"),
        (-1e-15, 8, "-1.00000000e-15"),
        (1.0, 8, "1"),
        (1.5, 8, "1.5"),
        ...
        (np.array([[1.0, 2.0], [3.0, 4.5]]), 8, "[[1, 2],\n [3, 4.5]]"),
        (np.array([[1.0000, 2.0000], [3.0000, 4.5000]]), 8, "[[1, 2],\n [3, 4.5]]"),
        # # --- Lists / tuples ---
