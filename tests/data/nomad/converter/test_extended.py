...
# Run `pynx nomad generate-metainfo --nx-class NXtest_extended` to regenerate.
...
from pynxtools.nomad.metainfo.base_classes.test import Test
...
class TestExtended(Test):
    ...
    entry = SubSection(
        section_def="pynxtools.nomad.metainfo.base_classes.test_extended.TestExtendedEntry",
        repeats=True,
        variable=True,
    )
